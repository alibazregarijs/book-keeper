...
CREATE TABLE "Notification" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "userGetReplyId" INTEGER NOT NULL,
    "bookId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_userGetReplyId_fkey" FOREIGN KEY ("userGetReplyId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "Book"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
